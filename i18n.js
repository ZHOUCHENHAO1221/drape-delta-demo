...
(function () {
  ...
  "Your garment opens in the DRAPE comparison page": "你的衣服会在 DRAPE 比较页面中打开",
  "DRAPE Helper uses CLO on this computer. Results and the PDF stay in your browser.": "DRAPE Helper 使用这台电脑上的 CLO。结果和 PDF 都留在浏览器里。",
  ...
  "Windows connector": "Windows 连接器",
  "Windows connector — install DRAPE Helper once, then open the comparison from here.": "Windows 连接器 —— 在这台电脑上安装一次 DRAPE Helper，之后从这里打开比较。",
  ...
  "3 · Return here and open the comparison workspace.": "3 · 回到这里，打开衣服比较工作区。",
  "4 · Choose one .zprj and two .zfab files. The files and simulation stay on this computer.": "4 · 选择一个 .zprj 和两个 .zfab。文件和模拟都留在这台电脑。",
  "DRAPE Helper opens the comparison in a browser tab. The report is shown and downloaded there.": "DRAPE Helper 会在浏览器标签页中打开比较，报告也在那里查看和下载。",
