...
(function () {
  ...
  function buildGateControls(launch) {
    ...
    g.querySelector('[data-gmail]').onclick = function () {
      ...
      DRAPE_AUTH.signInEmail(v).then(function () { b.textContent = 'sent ✓'; var h = g.querySelector('.ahint'); if (h) h.textContent = 'We emailed a sign-in link to ' + v + '. Click it to enter.'; })
